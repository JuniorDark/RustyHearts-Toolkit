    ...
    public partial class SetItemEditorViewModel : ObservableObject, IRecipient<ItemDataMessage>, IRecipient<DataRowViewMessage>
    {
        ...
        private async Task LoadFileFromPCK()
        {
            try
            {
                ...
                bool isLoaded = await DataTableManager.LoadFileFromPCK("setitem.rh", "setitem_string.rh");
        ...
        {
            Title = string.Format(Resources.EditorTitleFileName, "Set Item", DataTableManager.CurrentFileName);
            OpenMessage = "";
        ...
        private void OpenSearchDialog(string? parameter)
        {
            try
            {
                Window? window = Application.Current.Windows.OfType<SetItemEditorWindow>().FirstOrDefault();
        ...
        {
            Title = string.Format(Resources.EditorTitle, "Set Item");
        ...
        #region Properties
        [ObservableProperty]
        private string _title = string.Format(Resources.EditorTitle, "Set Item");
